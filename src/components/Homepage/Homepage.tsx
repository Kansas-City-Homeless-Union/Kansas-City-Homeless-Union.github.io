...
const Homepage = () => {
  return (
      <Stack gap={3}  divider={<Divider orientation="horizontal" flexItem />} >
          ...
          <Typography>
              The city is at war, not against homelessness, but against the homeless. We will not be silent. We demand to be heard.
              Our mission is nothing less than the end of homelessness in this City. This cannot and should not be done by simply moving us outside the city limits or imprisoning us. We will not be treated as an eyesore. 
              This cannot be done by simply hiring people or companies to provide services. These people are in the business of homelessness. If there are no more homeless to “help”, they cannot make money. This conflict of interest is what hampers us. They do not want to end homelessness, they want to profit from it.
              Those closest to the problem are closest to the solution. We must be provided with social housing, job training, job opportunities, and adequate healthcare, but most importantly we need the opportunity to help ourselves. We must be treated as human beings. We are not criminals just because we do not have a place to live.
          </Typography>
          <Stack gap={2}>
